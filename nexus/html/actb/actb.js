function actb(obj,ca){
	...
	/* --- Styles --- */
	this.actb_bgColor = '#f7fbfe';
	this.actb_textColor = '#014495';
	this.actb_hColor = '#ddf1fe';
	this.actb_fFamily = '"Lucida Grande", "Trebuchet MS", "Bitstream Vera Sans", Verdana, Helvetica, sans-serif';
